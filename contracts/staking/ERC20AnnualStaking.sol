...
contract ERC20AnnualStaking is Ownable, ReentrancyGuard, Pausable {
    ...
    uint256 private constant LOCK_PERIOD = 365 days; // um ano para o bloqueio
    uint256 private constant INITIAL_REWARD_RATE = 100; // 1.0% em base de pontos percentuais
    uint256 private constant FINAL_REWARD_RATE = 25; // 0.25% em base de pontos percentuais
    uint256 private constant MAX_STAKE = 2000000 * (10**18); // limite de 2.000.000 tokens (com 18 casas decimais)
    uint256 private constant REWARD_FEE_RATE = 1; // 1% taxa sobre a recompensa
    uint256 private constant REWARD_THRESHOLD = 15000 * (10**18); // Dividendos 15.000 - Distribuição para os Holders
    uint256 private constant MAX_REWARD_PERIOD = 545 days; // Período máximo de recompensa para o recebimento de recompensa
