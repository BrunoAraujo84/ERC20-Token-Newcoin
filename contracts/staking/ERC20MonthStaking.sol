...
contract ERC20MonthStaking is Ownable, ReentrancyGuard, Pausable {
    ...
    uint256 private constant LOCK_PERIOD = 30 days; // seis meses para bloqueio
    uint256 private constant INITIAL_REWARD_RATE = 20; // 0.20% em base de pontos percentuais
    uint256 private constant FINAL_REWARD_RATE = 20; // 0.20% em base de pontos percentuais
    uint256 private constant MAX_STAKE = 500000 * (10**18); // limite de 500.000 tokens (com 18 casas decimais)
